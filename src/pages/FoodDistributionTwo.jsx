...
const FoodDistributionTwo = () => {
  return (
    <div>
      <Header />
      <div class="mt-3">
        <div class="container">
          <div class="row gx-xxl-4 gy-4">
            <div class="col-lg-12 text-center">
              <p class="fw-semibold text-primary fs-4 fs-m-14 d-md-flex justify-content-center gap-2 mt-3 mt-lg-0 mb-1">अन्नं ब्रह्मा रसो विष्णुर्भोक्ता देवो
                महेश्वर:।</p>

              <h3 class="fw-semibold fs-m-14 fs-5 px-2 mb-0 mb-lg-2">Food is Lord Brahma, Taste is Lord Vishnu and the
                Eater is Lord Maheshwar</h3>

            </div>
            <div class="col-lg-8  krishnayan cart position-relative">
              <div class="row gy-4">
                <section class="col-lg-12 px-0 px-lg-3">
                  <div class="swiper mainbanner">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <img src="../docs.krishnayangauraksha.org/dynamic_page/127676904fooder.jpg" class="d-none d-lg-block rounded w-100 img-fluid" alt="Adopt A Cow Banner"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="mobile-banner d-lg-none">
                    <div class="swiper mobile-slider2">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/198778215917275157581.webp" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/184833243817275157582.webp" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/54654705717275157583.webp" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/119267159717275157584.webp" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/115131646817275157585.webp" alt=""/>
                        </div>
                      </div>
                      <div class="swiper-pagination"></div>
                    </div>
                    <h3>Humanity Starts With Charity</h3>
                    <p>Protecting & Sheltering Over 21000 Stray & Rescued Gauvansh</p>
                  </div>

                </section>
                <section class="col-lg-12 allpjustify">
                  <h5 class="addbullet">Annadaan/ Bhandara (Food
                    Distribution)</h5>
                  <p class="mb-0">At shree Krishnayan Gaushala, we embrace this tradition by
                    organizing Annadaan campaigns that extend a helping hand to saints, Tapaswis,
                    Under-privileged and to the poor section of the society, who cannot afford a
                    meal.
                  </p>
                </section>
                ...
                <section class="col-lg-12">
                  ...
                  <div class="row g-2 mb-4" id="donatetable">
                    ...
                    <div class="col-12 position-relative">
                      <h4 class="newheading">Quench Hunger</h4>
                    </div>
                    <div class="col-xl-4 col-lg-6  col-6">
                      <div class="card  newcard mncard">
                        <div class="card-body">
                          <h3 class="italic">Food distribution</h3>

                          <img src="https://docs.krishnayangauraksha.org/post_thumbnail/13_05_2024_00_42_16food-d.webp"
                            width="382" height="160" class="img-fluid" alt="Food distribution"/>

                            <div class="showtwolines paragraph-text"> You can feed hungry child and people in list. Select from the list
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6  col-6">
                      <div class="card  newcard mncard">
                        <div class="card-body">
                          <h3 class="italic">Dry rations</h3>

                          <img src="../docs.krishnayangauraksha.org/post_thumbnail/13_12_2023_18_22_57dry.jpg"
                            width="382" height="160" class="img-fluid" alt="Dry rations"/>

                            <div class="showtwolines paragraph-text"> We extend a helping hand to the needy and poor families by providing essential dry rations. Then can cook their meal at home. Dry rations will include  small unit of all items required to cook food </div>
                            <div class="text-warning fs-14  read-more" role="button">Read more</div>


                            <button class="btn  btn-warning   mt-lg-3 d-flex align-items-center  justify-content-center"
                              id="category_ID85"
                              onclick="productmodel(85,9)">
                              <i class="fa-solid fa-cart-shopping"></i> Add
                              Items <span class="ms-1"> to Donate</span></button>
                    ...
                    <div class="col-12 position-relative">
                      <h4 class="newheading">Daily Necessities</h4>
                    </div>
                    <div class="col-xl-4 col-lg-6  col-6">
                      <div class="card  newcard mncard">
                        <div class="card-body">
                          <h3 class="italic">Winter necessities</h3>

                          <img src="../docs.krishnayangauraksha.org/post_thumbnail/13_12_2023_19_39_36winter.jpg"
                            width="382" height="160" class="img-fluid" alt="Winter necessities"/>

                            <div class="showtwolines paragraph-text"> As the winter chill sets in, we provide warmth to the homeless and needy with blankets, shoes, clothes, umbrellas, and winter essentials. Your support brings comfort to those in need. </div>
                            <div class="text-warning fs-14  read-more" role="button">Read more</div>


                            <button class="btn  btn-warning   mt-lg-3 d-flex align-items-center  justify-content-center"
                              id="category_ID86"
                              onclick="productmodel(86,9)">
                              <i class="fa-solid fa-cart-shopping"></i> Add
                              Items <span class="ms-1"> to Donate</span></button>
                    ...
                    <div class="col-xl-4 col-lg-6  col-6">
                      <div class="card  newcard mncard">
                        <div class="card-body">
                          <h3 class="italic">Annadaan</h3>

                          <img src="https://docs.krishnayangauraksha.org/post_thumbnail/13_05_2024_00_40_40anndan.webp"
                            width="382" height="160" class="img-fluid" alt="Annadaan"/>

                            <div class="showtwolines paragraph-text"> You can feed saints, Tapaswis, Fakkars, devotees on the foothills of Himalayas </div>
                            <div class="text-warning fs-14  read-more" role="button">Read more</div>


                            <button class="btn  btn-warning   mt-lg-3 d-flex align-items-center  justify-content-center"
                              id="category_ID64"
                              onclick="productmodel(64,9)">
                              <i class="fa-solid fa-cart-shopping"></i> Add
                              Items <span class="ms-1"> to Donate</span></button>
                  ...
                  <div class="modal" id="newpaymentmodal" tabindex="-1">
                    <div class="modal-dialog modal-fullscreen-md-down">
                      ...
                      <section class="col-lg-12 allpjustify fourlinereadmorebox">
                        <div class="row gy-3 mt-2">
                          <div class="col-lg-7">
                            <h5 class="addbullet">Cause </h5>
                            <a href="new-assets/images/food/1x/food-1-50.jpg" data-fancybox=""
                              class="position-relative d-lg-none mb-3 d-block">
                              <img src="new-assets/images/food/1x/food-1-50.jpg" class="rounded-4 fixratio"
                                alt=""/>
                                <span class="innerlargeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                            </a>
                            <p class="show4line mb-0">
                              Annadaan, Shree krishnayan Gaurakshashala's free food
                              distribution program, is a cornerstone of our mission. Our Free Food
                              Distribution Drive continues throughout the year. Nutritious &
                              hygienically cooked food is distributed & served to the needy. During
                              critical times such as natural disasters or emergencies, we also
                              organize Bhandara, providing sustenance when humanity is in dire need.
                              Upholding the highest quality standards, we ensure that the food offered
                              is of utmost quality.
                            </p>
                            <div class="readmore-4line-btn  text-black-75 text-primary mt-3" role="button">
                              Read
                              More <i class="fa fa-angle-double-down"></i></div>
                          </div>
                          ...
                          <div class="col-lg-12 readmore-content dnone">
                            <p>Annadaan is the act of providing food to the hungry, is a revered
                              tradition
                              deeply ingrained in our culture. It symbolizes the essence of Brahma,
                              Vishnu,
                              and Maheshwar, and holds a supreme place among all forms of charity and
                              rituals.
                              At shree Krishnayan Gaushala, we embrace this tradition by organizing
                              Annadaan
                              campaigns that extend a helping hand to saints, Tapaswis, devotees, and
                              the less
                              privileged.</p>
                            <p class="mb-0">Discover the joy of giving through Shree krishnayan's
                              impactful Annadaan
                              Campaign, dedicated to feeding the underprivileged and revered sadhus.
                              This
                              noble initiative, orchestrated by our non-profit organization, strives
                              to offer
                              nourishing meals to those in need. By joining this endeavor, you can
                              significantly contribute to mitigating hunger and malnutrition among the
                              needy
                              souls.</p>
                          </div>
                        </div>
                      ...
                      <section class="col-lg-12">
                        <ul class="achives rainbow">
                          <li class="ribbon">
                            <h3>Quality, Healthy & fresh food is served.
                            </h3>
                          </li>
                          <li class="ribbon">
                            <h3>We even give uncooked rations to poor families</h3>
                          </li>
                          <li class="ribbon">
                            <h3>Cater to hungry & needy people and economically deprived sections in
                              need
                            </h3>
                          </li>
                          <li class="ribbon">
                            <h3>We provide relief at the time of any calamities or emergency</h3>
                          </li>
                        </ul>
                      </section>
                      ...
                      <section class="col-lg-12">
                        ...
                        <div class="position-relative sarrows">
                          <div class="swiper videosSlider">
                            <div class="swiper-wrapper">
                              <div class="swiper-slide videowrapper d-none d-lg-block">
                                ...
                                <div class="introvideo videoButton " data-video-id="tty9itfq1no" role="button">
                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                    data-src="https://img.youtube.com/vi/tty9itfq1no/hqdefault.jpg" width="614" height="345"
                                ...
                                <div class="swiper-slide videowrapper d-lg-none">
                                  <div class="introvideo videoButton " data-video-id="tty9itfq1no" role="button">
                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                      data-src="https://img.youtube.com/vi/tty9itfq1no/hqdefault.jpg" width="1920" height="1080"
                                      class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                        data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                        class="play-icon lazyload" alt="Play Icon"/>
                          ...
                          <section>
                            <h5 class="addbullet">Recent Updates</h5>
                            <div class="urgent-swiper-box">
                              <div class="swiper urgent-updates">
                                <div class="swiper-wrapper">
                                  <div class="swiper-slide">
                                    <div class="alertmsg">
                                      <div class="row g-4">
                                        <div class="col-lg-5">
                                          <div class="videowrapper h-100">
                                            <div class="introvideo videoButton h-100" data-video-id="VR--LhaIo-g"
                                              role="button">
                                              <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                data-src="https://img.youtube.com/vi/VR--LhaIo-g/hqdefault.jpg"
                                                width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                alt="About Krishnayan Video Thumbnail"/>
                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                  data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg"
                                                  width="70" height="70" class="play-icon lazyload" alt="Play Icon"/>
                                                </div>
                                            </div>
                                          </div>
                                          <div class="col-lg-7">
                                            <h3 class="fs-4 mb-3 ">Food distribution to needy</h3>
                                            <p><i class="fa-solid fa-calendar-days"></i> 2024-12-07 19:26:34</p>
                                            <p class="mb-0"><p>Food distribution being performed for needy</p></p>
                                            <div class="d-flex align-items-center gap-1 mt-4">
                                               <button
                                                class="btn btn-primary">Help & Save Life</button> 
                                              <div class="next-issue btn btn-primary">Previous Update</div>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="swiper-slide">
                                      <div class="alertmsg">
                                        <div class="row g-4">
                                          <div class="col-lg-5">
                                            <div class="videowrapper h-100">
                                              <div class="introvideo videoButton h-100" data-video-id="rKjWzpsnO3s"
                                                role="button">
                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                  data-src="https://img.youtube.com/vi/rKjWzpsnO3s/hqdefault.jpg"
                                                  width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                  alt="About Krishnayan Video Thumbnail"/>
                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                    data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg"
                                            ...
                                            <div class="col-lg-7">
                                              <h3 class="fs-4 mb-3 ">Food to child</h3>
                                              <p><i class="fa-solid fa-calendar-days"></i> 2024-12-19 13:40:37</p>
                                              <p class="mb-0"><p>Food being distributed to hungry children</p></p>
                                              <div class="d-flex align-items-center gap-1 mt-4">
                                                 <button
                                                  class="btn btn-primary">Help & Save Life</button> 
                                                <div class="next-issue btn btn-primary">Previous Update</div>
                                      ...
                                      <div class="swiper-slide">
                                        <div class="alertmsg">
                                          <div class="row g-4">
                                            <div class="col-lg-5">
                                              <div class="videowrapper h-100">
                                                <div class="introvideo videoButton h-100" data-video-id="58lt-Geuqcw"
                                                  role="button">
                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                    data-src="https://img.youtube.com/vi/58lt-Geuqcw/hqdefault.jpg"
                                                    width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                    alt="About Krishnayan Video Thumbnail"/>
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                      data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg"
                                              ...
                                              <div class="col-lg-7">
                                                <h3 class="fs-4 mb-3 ">Food to needy</h3>
                                                <p><i class="fa-solid fa-calendar-days"></i> 2024-12-31 20:01:25</p>
                                                <p class="mb-0"><p>Food being distributed between needy</p></p>
                                                <div class="d-flex align-items-center gap-1 mt-4">
                                                   <button
                                                    class="btn btn-primary">Help & Save Life</button> 
                                                  <div class="next-issue btn btn-primary">Previous Update</div>
                                        ...
                                        <div class="swiper-slide">
                                          <div class="alertmsg">
                                            <div class="row g-4">
                                              <div class="col-lg-5">
                                                <div class="videowrapper h-100">
                                                  <div class="introvideo videoButton h-100" data-video-id="h254AmV7SMU"
                                                    role="button">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                      data-src="https://img.youtube.com/vi/h254AmV7SMU/hqdefault.jpg"
                                                      width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                      alt="About Krishnayan Video Thumbnail"/>
                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                        data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg"
                                                ...
                                                <div class="col-lg-7">
                                                  <h3 class="fs-4 mb-3 ">Food distribution to needy</h3>
                                                  <p><i class="fa-solid fa-calendar-days"></i> 2025-01-02 18:57:30</p>
                                                  <p class="mb-0"><p>Food Prasad Distributed to the Needy by Shree Krishnayan Annadan Sewa</p></p>
                                                  <div class="d-flex align-items-center gap-1 mt-4">
                                                     <button
                                                      class="btn btn-primary">Help & Save Life</button> 
                                                    <div class="next-issue btn btn-primary">Previous Update</div>
                                          ...
                                          <div class="swiper-slide">
                                            <div class="alertmsg">
                                              <div class="row g-4">
                                                <div class="col-lg-5">
                                                  <div class="videowrapper h-100">
                                                    <div class="introvideo videoButton h-100" data-video-id="HQQIP9gaeRo"
                                                      role="button">
                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                        data-src="https://img.youtube.com/vi/HQQIP9gaeRo/hqdefault.jpg"
                                                        width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                        alt="About Krishnayan Video Thumbnail"/>
                                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                          data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg"
                                                  ...
                                                  <div class="col-lg-7">
                                                    <h3 class="fs-4 mb-3 ">Food to needy</h3>
                                                    <p><i class="fa-solid fa-calendar-days"></i> 2025-01-03 20:02:42</p>
                                                    <p class="mb-0"><p>Food being distributed to needy</p></p>
                                                    <div class="d-flex align-items-center gap-1 mt-4">
                                                       <button
                                                        class="btn btn-primary">Help & Save Life</button> 
                                                      <div class="next-issue btn btn-primary">Previous Update</div>
                                            ...
                                            <div class="swiper-slide">
                                              <div class="alertmsg">
                                                <div class="row g-4">
                                                  <div class="col-lg-5">
                                                    <div class="videowrapper h-100">
                                                      <div class="introvideo videoButton h-100" data-video-id="3xPSCVsHoUc"
                                                        role="button">
                                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                          data-src="https://img.youtube.com/vi/3xPSCVsHoUc/hqdefault.jpg"
                                                          width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                          alt="About Krishnayan Video Thumbnail"/>
                                                          <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                            data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg"
                                                    ...
                                                    <div class="col-lg-7">
                                                      <h3 class="fs-4 mb-3 ">Ration kit for needy</h3>
                                                      <p><i class="fa-solid fa-calendar-days"></i> 2025-02-01 20:09:33</p>
                                                      <p class="mb-0"><p>Ration kits distributed to the needy.</p></p>
                                                      <div class="d-flex align-items-center gap-1 mt-4">
                                                         <button
                                                          class="btn btn-primary">Help & Save Life</button> 
                                                        <div class="next-issue btn btn-primary">Previous Update</div>
                                              ...
                                              <div class="swiper-slide">
                                                <div class="alertmsg">
                                                  <div class="row g-4">
                                                    <div class="col-lg-5">
                                                      <div class="videowrapper h-100">
                                                        <div class="introvideo videoButton h-100" data-video-id="tnovKoVziX4"
                                                          role="button">
                                                          <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                            data-src="https://img.youtube.com/vi/tnovKoVziX4/hqdefault.jpg"
                                                            width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                            alt="About Krishnayan Video Thumbnail"/>
                                                            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                              data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg"
                                                      ...
                                                      <div class="col-lg-7">
                                                        <h3 class="fs-4 mb-3 ">Bhandara on the occassion of Mahashivratri</h3>
                                                        <p><i class="fa-solid fa-calendar-days"></i> 2025-02-26 20:03:08</p>
                                                        <p class="mb-0"><p><span>On the auspicious
                                                          occasion of Mahashivratri, a Bhandara was organized for saints and devotees at
                                                          Shree Krishnayan.</span></p></p>
                                                        <div class="d-flex align-items-center gap-1 mt-4">
                                                           <button
                                                            class="btn btn-primary">Help & Save Life</button> 
                                                          <div class="next-issue btn btn-primary">Previous Update</div>
                                        ...
                                        <section class="col-lg-12 allpjustify fourlinereadmorebox">
                                          <div class="row gy-3 mt-2">
                                            ...
                                            <div class="col-lg-7">
                                              <h5 class="fw-semibold mb-3 addbullet">Why Annadaan? </h5>
                                              <a href="new-assets/images/food/1x/food-2-50.jpg" data-fancybox=""
                                                class="position-relative d-block d-lg-none mb-3">
                                                <img src="new-assets/images/food/1x/food-2-50.jpg" class="rounded-4 fixratio"
                                                  alt=""/>
                                                  <span class="innerlargeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                              </a>
                                              <p class="show4line">
                                                India confronts a pressing hunger crisis, ranking
                                                107th out of 121 countries in
                                                the 2022 Global Hunger Index. An estimated 189.2 million Indians suffer
                                                from
                                                undernourishment, with a substantial population below the poverty line
                                                according
                                                to the United Nations Development Programme.
                                              </p>
                                              <p class="dnone mb-0"> Food stands as humanity's fundamental need.
                                                Bestowing Annadaan upon devotees
                                                holds a celestial promise – one attains heaven within our
                                                Universe. </p>
                                              <div class="readmore-4line-btn  text-black-75 text-primary mt-3" role="button">
                                                Read
                                                More <i class="fa fa-angle-double-down"></i></div>
                                            ...
                                            <div class="col-lg-12 readmore-content dnone">
                                              ...
                                              <p>Through this noble act, nourishing both body and soul, we forge a
                                                bridge
                                                to realms beyond, etching our place in the cosmic symphony.</p>
                                              <p class="mb-0">In the foothills of the Himalayas and on the banks of Maa
                                                Ganga,
                                                numerous
                                                seekers and devotees pass through spiritual paths. Your
                                                contribution to
                                                Annadaan not only provides nourishment to their bodies but also
                                                feeds
                                                their souls. In
                                                a world where many struggle for their next meal, your act of
                                                kindness
                                                can make a
                                          ...
                                          <div class="sarrows">
                                            ...
                                            <div class="position-relative">
                                              <div class="swiper galleryslider">
                                                <div class="swiper-wrapper">
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/784511930g1.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/784511930g1.jpg" alt=""/>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/688470586g2.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/688470586g2.jpg" alt=""/>
                                                        <span class="largeicon"><i class="fa fa-expand"
                                                          aria-hidden="true"></i></span>
                                                    </a>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/145251944g3.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/145251944g3.jpg" alt=""/>
                                                        <span class="largeicon"><i class="fa fa-expand"
                                                          aria-hidden="true"></i></span>
                                                    </a>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/427937805g4.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/427937805g4.jpg" alt=""/>
                                                        <span class="largeicon"><i class="fa fa-expand"
                                                          aria-hidden="true"></i></span>
                                                    </a>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/105537766g5.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/105537766g5.jpg" alt=""/>
                                                        <span class="largeicon"><i class="fa fa-expand"
                                                          aria-hidden="true"></i></span>
                                                    </a>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/132556070g6.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/132556070g6.jpg" alt=""/>
                                                        <span class="largeicon"><i class="fa fa-expand"
                                                          aria-hidden="true"></i></span>
                                                    </a>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/813776197g7.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/813776197g7.jpg" alt=""/>
                                                        <span class="largeicon"><i class="fa fa-expand"
                                                          aria-hidden="true"></i></span>
                                                    </a>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <a href="../docs.krishnayangauraksha.org/dynamic_page/931039113g8.jpg" data-fancybox="gallery">
                                                      <img src="../docs.krishnayangauraksha.org/dynamic_page/931039113g8.jpg" alt=""/>
                                                        <span class="largeicon"><i class="fa fa-expand"
                                                          aria-hidden="true"></i></span>
                                                    </a>
                                        ...
                                        <section class="col-lg-12">
                                          <div class="row gy-3 fourlinereadmorebox mt-3">


                                            <div class="col-lg-7">
                                              <h5 class="fw-semibold mb-3 addbullet">Religious Benefits: Blessings and
                                                Transformation
                                              </h5>
                                              <img src="new-assets/images/food/1x/food-3-50.jpg"
                                                class="rounded-4 fixratio d-lg-none  mb-3 d-block" alt=""/>
                                                <p class="show4line">In the timeless verses of the Mahabharata, Yudhishthira
                                                  Maharaj's
                                                  query
                                                  echoed:
                                                  "What offering yields reward here and in the beyond?" Bhishma's
                                                  response
                                                  resonated: "None matches, nor ever will, the gift of food."
                                                  These words,
                                                  etched
                                                  in the Anusasana Parva 13.63.3-6.</p>
                                                <p class="dnone mb-0">Ancient scriptures extol Annadaan as one of the most
                                                  virtuous deeds. By
                                                  participating in our Annadaan campaign, you invite blessings
                                                  that can
                                                  transform
                                                  your life. </p>
                                                <div class="readmore-4line-btn  text-black-75 text-primary" role="button">
                                                  Read
                                                  More <i class="fa fa-angle-double-down"></i></div>
                                            </div>
                                            <div class="col-lg-5">
                                              <img src="new-assets/images/food/1x/food-3-50.jpg"
                                                class="rounded-4 fixratio d-lg-block d-none" alt=""/>
                                            </div>
                                            <div class="col-lg-12 readmore-content dnone">
                                              <p>The act of sharing resonates deeply with the teachings of
                                                our
                                                scriptures, bringing you closer to spiritual fulfillment.</p>
                                        ...
                                        <section class="col-lg-12 fourlinereadmorebox allpjustify">
                                          <div class="row gy-3">

                                            <div class="col-lg-5 d-lg-block d-none">
                                              <img src="new-assets/images/food/1x/food-4-50.jpg" class="rounded-4 fixratio " alt=""/>
                                            </div>
                                            <div class="col-lg-7">
                                              <h5 class="fw-semibold mb-3 addbullet">Touching divine Souls</h5>
                                              <img src="new-assets/images/food/1x/food-4-50.jpg"
                                                class="rounded-4 fixratio d-lg-none d-block mb-3" alt=""/>
                                                <p class="show4line">Our Annadaan reaches not only the hungry but also those
                                                  saintly
                                                  souls
                                                  who've
                                                  spent years in Himalayan tapasya. Their presence imparts a
                                                  divine
                                                  ambiance to
                                                  the nourishment you provide. When you savor your meal, you
                                                  ingest not
                                                  just food
                                                  but a divine vibe that touches your soul.</p>

                                                <p class="mb-0 dnone ">Join hands with shree Krishnayan Gaushala and
                                                  be a
                                                  part of
                                                  our Annadaan /Bhandara
                                                  campaign. By providing meals to sadhus, saints, tapasvis, and
                                                  the
                                                  hungry, you
                                                  become a collaborator in good karma.</p>
                                                <div class="readmore-4line-btn  text-black-75 text-primary" role="button">
                                                  Read
                                                  More <i class="fa fa-angle-double-down"></i></div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                              <div class="readmore-content dnone">
                                                <p> Saints and tapaswis in Haridwar/Rishikesh
                                                  partake in these meals, bestowing their blessings upon you on
                                                  your
                                                  auspicious
                                                  day.</p>
                                                <p class="mb-0">Shree krishnayan Gaurakshashala stands witness to
                                                  the
                                                  devoted efforts of numerous
                                                  sanyasis, tapaswis, brahmacharis, residents, and volunteers.
                                                  Their
                                                  commitment to
                                                  diverse spiritual and social endeavors for the well-being of
                                                  Gaumata is
                                                  remarkable. Annadaan blesses these dedicated souls, as well as
                                                  the
                                                  destitute. By
                                                  partaking in this act, you extend your reach to touch another
                                                  life while
                                                  enhancing your own.</p>
                                              </div>
                                        ...
                                        <section class="col-lg-12 fourlinereadmorebox">
                                          <div class="row gy-3">


                                            <div class="col-lg-12">
                                              <h5 class="fw-semibold  mb-0 addbullet">How to Contribute </h5>
                                            </div>
                                            <div class="col-lg-12 allpjustify">

                                              <p class="show4line">Our mission is to combat hunger and malnutrition
                                                prevailing in
                                                society. With your
                                                steadfast monthly contributions, this campaign can serve
                                                thousands of meals
                                                daily, making a tangible impact. Your donation can truly alter
                                                lives, providing
                                                sustenance for numerous individuals each day. Every single rupee
                                                holds
                                                significance, as your donation directly aids those in dire need.

                                              </p>
                                              <p class="readmore-content dnone">
                                                Your support matters. Your donation can sustain our Annadaan
                                                campaigns and touch
                                                countless lives. Every morsel you provide is an offering of love
                                                and sustenance,
                                                radiating positivity and kindness. Become a conduit of change
                                                through our
                                                Annadaan initiative and experience the profound joy of giving.
                                                Participate in
                                                the Shree krishnayan Gaurakshashala's Annadaan Campaign today
                                                and become an
                                                integral part of this noble endeavor. As a token of our
                                                gratitude, donors can
                                                avail 80G Tax Exemption for each contribution made to Shree
                                                krishnayan
                                                Gaurakshashala. Your generosity shapes a brighter, nourished
                                                future for many.
                                              </p>

                                              <p class="readmore-content dnone">

                                                Seize the golden opportunity to enfold yourself in the blessings
                                                of the revered
                                                33 crore deities through the profound act of Annadaan Seva. Step
                                                onto this
                                                transformative path of selflessness and compassion, and feel the
                                                divine grace of
                                                the Supreme bestow upon you. Your generosity can make a world of
                                                difference.
                                                Join our Annadanam campaign and provide a meal to those in need.
                                                Every
                                                contribution counts. Let us come together to uphold this
                                                timeless tradition,
                                                nourishing bodies and spirits alike. With your participation, we
                                                can continue to
                                                serve the divine in every soul we reach.</p>
                                        ...
                                        <section class="col-lg-12 allpjustify fourlinereadmorebox" id="about">

                                          <h5 class="addbullet">About us</h5>
                                          <p class="show4line">Shree Krishnayan Desi Gauraksha Evam Gaulok Dham Sewa Samiti’
                                            is one of
                                            the
                                            ...
                                            which are abandoned by their owners or saved from butchers. Most of
                                            these
                                            Gauvansh are milk barren. These cows are brought to our Gaushala from
                                            tough
                                            conditions. All these cows are fed, sheltered, and looked after by
                                            hundreds
                                            of Gausewaks who work round the clock. This Gaushala is run and managed
                                            by
                                            saints. We do not exploit these cows for milk but distribute it free to
                                            saints / tapaswis / Gausewaks / Ashrams.</p>
                                          <p class="dnone">We started with just 11 cows in the year 2010 in Haridwar,
                                            and
                                            presently we shelter and feed more than 21000 cows & Bulls in various
                                            locations all put together. This number is ever-increasing as stray Desi
                                            Cows & Bulls mostly deserted by their owner are brought to our
                                            Gaurakshashala every day.</p>
                                          <div class="readmore-4line-btn  text-black-75 text-primary" role="button">Read
                                            More <i class="fa fa-angle-double-down"></i></div>

                                          <div class="position-relative sarrows mt-4">
                                            <div class="swiper ducumentslider">
                                              <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                  <a class="fancybox" data-fancybox rel="group"
                                                    href="../docs.krishnayangauraksha.org/donation_page/images/about/animal-welfare-board%2c-chennai_page-0001-(1)-big.jpg"><img
                                                      ...
                                                      alt="Animal Welfare Board of India Certificate"/></a>
                                                </div>
                                                <div class="swiper-slide">
                                                  <a class="fancybox" data-fancybox rel="group"
                                                    href="../docs.krishnayangauraksha.org/donation_page/images/about/iso-9001-certificate-1.jpg"><img
                                                      ...
                                                      alt="ISO Certificate of Krishnayan Gauraksha"/></a>
                                                </div>
                                                <div class="swiper-slide">
                                                  <a class="fancybox" data-fancybox rel="group"
                                                ...
                                                <div class="swiper-slide">
                                                  <a class="fancybox" data-fancybox rel="group"
                                                    href="../docs.krishnayangauraksha.org/donation_page/images/about/IMG-20210227-WA0057-big.jpg"><img
                                                      ...
                                                      alt="Uttrakhand Animal Welfare Board"/></a>
                                                </div>
                                              </div>
                                            </div>
                                            <div class="swiper-button-next dnext"></div>
                                            <div class="swiper-button-prev dprev"></div>
                                          </div>
                                       ...
                                       <section class="template__section pt-3" id="about-ekadashi">
                                        <div class="pt-3">
                                          <h3 class="heading border-bottom-2"><p>Cause:-</p></h3>
                                        </div>
                                        <div class="mt-2 text-justify addreadmore"><p><span style={{color:"rgb(0,0,0)"}}><strong>Annadaan: Free Food Distribution by Shree Krishnayan Gaurakshashala</strong> Annadaan, Shree Krishnayan Gaurakshashala's free food distribution program, is central to our mission. We conduct our Free Food Distribution Drive consistently throughout the year, providing nutritious and hygienically cooked meals to those in need. During critical times like natural disasters or emergencies, we extend our support by organizing Bhandara, ensuring sustenance for those facing dire circumstances. Upholding the highest standards of quality, we ensure that every meal served meets stringent quality criteria. Join us in our commitment to serve humanity with compassion and care.</span></p></div>
                            ...
                            export default FoodDistributionTwo
