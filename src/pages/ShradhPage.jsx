    ...
    <div>
      ...
      <div class="mt-1">
        <div class="container">
          <div class="row gy-2">
            <div class="col-lg-12">
              <div class="p-2 text-center fw-semibold ">
                <p
                  class="text-center fw-semibold text-primary fs-4 fs-m-14 d-md-flex justify-content-center gap-2 mt-3 mt-lg-0 mb-1">
                  यत्र गाव: प्रसन्नाः स्युः
                  प्रसन्नास्तत्र सम्पदः । <span class="d-block d-lg-inline"> यत्र गावो विषण्णाः
                    स्युर्विषण्णास्तत्र सम्पदः ॥ </span></p>
                <p class="text-center fw-semibold fs-m-14 fs-5 mb-0 mb-lg-2">Where cows are happy, prosperity is there. Where cows are in
                  grief,
                  adversity is there.</p>
              </div>
            </div>
            <div class="col-lg-8 slider-box krishnayan cart">
              <div class="row">
                <div class="col-lg-12 px-0 px-lg-3">
                  <h1 class="sliderh1 d-none d-lg-block">Shradh (Pitru Paksha)</h1>
                  <div class="swiper">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <img src="https://docs.krishnayangauraksha.org/dynamic_page/2120593137shardh.webp" class="d-none d-lg-block rounded-bottom-4 w-100" alt="Shradh banner"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="mobile-banner d-lg-none">
                    <div class="swiper mobile-slider2">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/14887450917275049781.webp" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/53200983217275049782.webp" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/121698236617275049783.webp" alt=""/>
                        </div>
                      </div>
                      <div class="swiper-pagination"></div>
                    </div>
                    <h3>Offer Peace to Your Loved Ones with shradh, tarpan, & Gau daan on the sacred banks of maa ganga</h3>
              ...
              <br/>
                ...
                <div class="row g-2 mb-4" id="donatetable">
                  ...
                  <div class="col-xl-4 col-lg-6  col-6">
                    <div class="card  newcard mncard">
                      <div class="card-body">
                        <h3 class="italic">Monthly care </h3>

                        <img src="https://docs.krishnayangauraksha.org/post_thumbnail/17_09_2024_16_44_34monthly-care-cow.webp"
                          width="382" height="160" class="img-fluid" alt="Monthly care "/>

                          <div class="showtwolines paragraph-text"> Shree Krishnayan Desi Gauraksha shelters destitute cows & bulls mostly abandoned by their owners. You can adopt these gauvansh and can give them a happy second life. </div>
                          <div class="text-warning fs-14  read-more" role="button">Read more</div>


                          <button class="btn  btn-warning   mt-lg-3 d-flex align-items-center  justify-content-center"
                            id="category_ID3"
                            onclick="productmodel(3,6)">
                            <i class="fa-solid fa-cart-shopping"></i> Add
                            Items <span class="ms-1"> to Donate</span></button>
                  ...
                  <div class="col-12 position-relative">
                    <h4 class="newheading">Shradh</h4>
                  </div>
                  <div class="col-xl-4 col-lg-6  col-6">
                    <div class="card  newcard mncard">
                      <div class="card-body">
                        <h3 class="italic">Shradh</h3>

                        <img src="https://docs.krishnayangauraksha.org/post_thumbnail/16_09_2024_14_03_04sradh.webp"
                          width="382" height="160" class="img-fluid" alt="Shradh"/>

                          <div class="showtwolines paragraph-text">  Shradh is a ritual to pay homage to one's deceased family members-  ancestors. You can choose from different kind of rituals which can be performed on your chosen date. </div>
                          <div class="text-warning fs-14  read-more" role="button">Read more</div>


                          <button class="btn  btn-warning   mt-lg-3 d-flex align-items-center  justify-content-center"
                            id="category_ID8"
                            onclick="productmodel(8,6)">
                            <i class="fa-solid fa-cart-shopping"></i> Add
                            Items <span class="ms-1"> to Donate</span></button>
                ...
                <div class="modal" id="newpaymentmodal" tabindex="-1">
                  <div class="modal-dialog modal-fullscreen-md-down">
                    ...
                    <input type="hidden" id="payment_mode_ownwish" name="payment_mode_ownwish" value=""/>
                      ...
                      <section class="template__section" id="Cause">
                        <div class="pt-3">
                          <h4 class="heading border-bottom-2">Shradh (Pitru Paksha)</h4>

                          <div class="row gy-4">
                            <div class="col-lg-12">
                              <div class="row gy-5  fourlinereadmorebox">
                                <div class="col-lg-12">

                                  <a href="new-assets/images/shradh/1.html" data-fancybox=""
                                    class="position-relative d-block rightimage"> <img
                                      src="new-assets/images/shradh/1.html" class="fixratio" width="350"
                                      height="300" alt=""/>
                                      <span class="innerlargeicon"><i class="fa fa-expand"
                                        aria-hidden="true"></i></span>
                                  </a>
                                  <h2 class="fw-semibold fs-6">About Ancestral Blessings, Date, Rituals and
                                    Significance
                                  </h2>
                                  <p class=" text-justify"> According to the Vedic tradition in Hindu religion,
                                    there
                                    are many customs, fasts, and festivals. Under this, Shradh of ancestors is
                                    also
                                    performed. Shradh rituals can be performed on the Amavasya date of every
                                    month,
                                    but there is a rule to perform shradh rituals in the entire fortnight from
                                    the
                                    full moon day of Bhadrapada month to the new moon day of Ashwin month. This
                                    festival of paying homage to our ancestors is called Shradh. According to
                                    the
                                    Hindu calendar, the period from the full moon of Bhadrapada month to the new
                                    moon of Ashwin month is called Pitru Paksha. <br/><br/> The practice of Shradh
                                      has
                                      been going on since the Vedic period. The purpose of Shradh is to pay homage
                                      to
                                      our ancestors and pray for the satisfaction of their souls. It is said that
                                      only
                                      the water offered during Shradh i.e. Pitru Paksha brings peace and salvation
                                      to
                                      the souls of the ancestors. </p>
                              ...
                              <div class="col-lg-12">
                                <div class="row gy-4 fourlinereadmorebox">

                                  <div class="col-lg-12"> <a href="new-assets/images/shradh/2.html" data-fancybox=""
                                    class="position-relative d-block leftimage"><img
                                      src="new-assets/images/shradh/2.html" class=" fixratio" width="350"
                                      height="300" alt=""/>
                                      <span class="innerlargeicon"><i class="fa fa-expand"
                                        aria-hidden="true"></i></span></a>
                                    <h2 class="fw-semibold mb-2 fs-6">Pitru paksh shradh significance</h2>
                                    <p class="  text-justify">It is believed that a human being attains life after
                                      leaving 84 lakh births. When a child is born then he is in the form of a
                                      child
                                      but when he participates in Shradh rituals then he is truly called a son. By
                                      performing Shradh of ancestors with full devotion during Pitru Paksha, their
                                      souls get peace and there is no effect of Pitra Dosh. During Pitru Paksha,
                                      it is
                                      believed that the deceased ancestors are present on earth for 16 days and
                                      their
                                      wishes are fulfilled by burning cow dung cakes while performing Shradh
                                      rituals
                                      on the date of their death. <br/> <br/>Pitru Paksha is a 16 days’ period when
                                        one
                                        offers reverence to their ancestors in the form of Tarpan or Shradh Puja.
                                        Pitruruna ceremony and rituals carried by surviving son or sons on the
                                        'Shradh
                                        Thithi' is known as Varshika Shradh. Carrying out Varshika Shradh in
                                        'Teertha
                                        Kshetras' (holy places) has been considered highly meritorious as mentioned
                                        in
                                        Puranas. Thus, in the Puranas, the types of Shradh along with their
                                        importance
                                        are also described and the Shradh ritual performed in Pitru Paksha paves the
                                        way
                                        for progress. </p>
                                ...
                                <div class="col-lg-12 readmore-content dnone">
                                  <div class="row gy-3">
                                    <div class="col-lg-12">
                                      <a href="new-assets/images/shradh/3.html" data-fancybox=""
                                        class="position-relative d-block rightimage"> <img
                                          src="new-assets/images/shradh/3.html" class="fixratio"
                                          alt="Why is Pitru Paksha important?" width="350" height="300"/><span
                                            class="innerlargeicon"><i class="fa fa-expand"
                                              aria-hidden="true"></i></span> </a>
                                      <h5 class="fw-semibold  mb-2 fs-6">Why is Pitru Paksha important?
                                      </h5>
                                      <p class="  text-justify">Pitru Paksha is considered very important for the
                                        ancestors and the ancestors' family members. The ancestors are happy after
                                        receiving Tarpan, Ardhya and Bhaag from their descendants and shower their
                                        blessings. Due to the happiness of ancestors during Pitru Paksha, Pitra Dosh
                                        also gets removed and troubles go away</p>
                                ...
                                <div class="col-lg-12 readmore-content dnone">
                                  <div class="row gy-3 ">
                                    ...
                                    <div class="col-lg-12">
                                      <a href="new-assets/images/shradh/4.html" data-fancybox=""
                                        class="position-relative d-block leftimage"><img
                                          src="new-assets/images/shradh/4.html" class="fixratio"
                                          alt="Pitru Paksha 2024: Know Who Can Perform Shradh" width="350"
                                          height="300"/><span class="innerlargeicon"><i class="fa fa-expand"
                                            aria-hidden="true"></i></span></a>
                                      <h5 class="fw-semibold  mb-2 fs-6">Pitru Paksha 2024: Know Who Can Perform
                                        Shradh
                                      </h5>
                                      <p class=" text-justify">Mainly only the son has the right to perform the Shradh
                                        of the father. If there is more than one son, all the Shradh rituals should
                                        be
                                        performed by the eldest son. If there is no son then the wife should perform
                                        Shradh and in the absence of a wife, the elder brother or grandson,
                                        great-grandson, daughter-in-law, nephew are entitled to do it.</p>
                                ...
                                <div class="col-lg-12 readmore-content dnone">
                                  <div class="row gy-3 ">
                                    <div class="col-lg-12 ">
                                      <a href="new-assets/images/shradh/5.html"
                                        class="position-relative d-block rightimage" data-fancybox=""><img
                                          src="new-assets/images/shradh/5.html" width="350" height="300"
                                          class="rounded-4 fixratio" alt="Rituals performed on Shradh"/><span
                                            class="innerlargeicon"><i class="fa fa-expand"
                                              aria-hidden="true"></i></span></a>
                                      <h5 class="fw-semibold mb-2 fs-6">Rituals performed on Shradh
                                      </h5>
                                      <p class="text-justify ">For Pitru Paksha ritual, wake up and take bath before
                                        sunrise on Shradh date with reverence for the peace of ancestors. Wear clean
                                        clothes and take a pledge to perform Shradh and donate for the satisfaction
                                        of
                                        ancestors. Basically, remain hungry on the day of Shradh and prepare satvik
                                        food
                                        with full devotion. Keep Gogras, Panch Gras etc. aside and serve food in a
                                        plate
                                        in front of the photo of the deceased family member. With folded hands, pray
                                        to
                                        them to come and take food with pity. Pray for blessings for your children
                                        to be
                                        rich, prosperous and healthy. After this, satisfy the Brahmin by feeding him
                                        food to his heart's content and giving him donations as per his devotion and
                                        seek his blessings. After having the meal, feed the Gogras kept to the cow
                                        and
                                        the Panchagras to the crows, dogs, insects etc. After this the family
                                        members
                                        also have food. <br/><br/>
                                          This is the reason that every year during Pitru Paksha, people perform
                                          Shradh,
                                          Tarpan etc. for their ancestors with full devotion and faith. According to
                                          mythological belief, during Pitru Paksha, if someone performs Shradh for his
                                          ancestors on the date related to them, then his ancestors become happy and
                                          shower their full blessings on him.
                                        </p>
                                  ...
                                  <div class="col-lg-12 text-center">
                                    <button class="readmore-button btn btn-primary mx-auto text-white btn-sm"> Read More
                            ...
                            <section class="template__section mt-4">
                            ...
                            <ul class="achives rainbow my-4">
                              <li class="ribbon">ALL RITUALS PERFORMED BY VEDIC BRAHMINS</li>
                              <li class="ribbon">ALL RITUALS ARE DONE ON THE BANK OF MAA GANGA IN HARIDWAR / RISHIKESH</li>
                              <li class="ribbon">GODAAN IS OF DESI COWS ONLY WHICH WILL BE SHOWN LIVE</li>
                            ...
                            <section class="template__section" id="Cause">
                              <div class="pt-3">
                                <h2 class="heading border-bottom-2">Pitru Paksha 2024 Date –Tithi </h2>
                              </div>

                              <a href="new-assets/images/shradh/6.html" data-fancybox=""
                                class="position-relative d-block rightimage"><img src="new-assets/images/shradh/6.html"
                                  class=" fixratio" width="350" height="300" alt=""/>
                                  <span class="innerlargeicon"><i class="fa fa-expand" aria-hidden="true"></i></span></a>


                              <p class=" mt-3">It is believed that ancestors visit Earth during this period to receive the
                                offerings. Pitru
                                Paksha lasts from the full moon day of Bhadrapada month to the new moon day. Pitru Paksha start
                                on 17 September 2024, and end on 2 October 2024. It is considered an auspicious time to perform
                                rituals like Pitru Tarpan, Pind Daan, and Shradh.</p>
                              <div class="clearfix"></div>
                              <div class="table-responsive mt-4 w-100 ">
                                <table cellpadding="0" cellspacing="0"
                                  class="table fs-14 bg-transparent table-striped table-primary table-borderless">
                                  <tbody>
                                    <tr>
                                      <td><strong>Date</strong></td>
                                      <td><strong>Shraadh</strong></td>
                                      <td><strong>Tithi &amp; Nakshatra</strong></td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 17, 2024, Tuesday</strong></td>
                                      <td>Purnima Shraddha</td>
                                      <td>Bhadrapada, Shukla Purnima</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 18, 2024, Wednesday</strong></td>
                                      <td>Pratipada Shraddha</td>
                                      <td>Ashwina, Krishna Pratipada</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 19, 2024, Thursday</strong></td>
                                      <td>Dwitiya Shraddha</td>
                                      <td>Ashwina, Krishna Dwitiya</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 20, 2024, Friday</strong></td>
                                      <td>Tritiya Shraddha</td>
                                      <td>Ashwina, Krishna Tritiya</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 21, 2024, Saturday</strong></td>
                                      <td>Chaturthi Shraddha</td>
                                      <td>Ashwina, Krishna Chaturthi</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 21, 2024, Saturday</strong></td>
                                      <td>Maha Bharani</td>
                                      <td>Ashwina, Bharani Nakshatra</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 22, 2024, Sunday</strong></td>
                                      <td>Panchami Shraddha</td>
                                      <td>Ashwina, Krishna Panchami</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 22, 2024, Sunday</strong></td>
                                      <td>Shashthi Shraddha</td>
                                      <td>Ashwina, Krishna Shashthi</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 23, 2024, Monday</strong></td>
                                      <td>Saptami Shraddha</td>
                                      <td>Ashwina, Krishna Saptami</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 24, 2024, Tuesday</strong></td>
                                      <td>Ashtami Shraddha</td>
                                      <td>Ashwina, Krishna Ashtami</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 25, 2024, Wednesday</strong></td>
                                      <td>Navami Shraddha</td>
                                      <td>Ashwina, Krishna Navami</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 26, 2024, Thursday</strong></td>
                                      <td>Dashami Shraddha</td>
                                      <td>Ashwina, Krishna Dashami</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 27, 2024, Friday</strong></td>
                                      <td>Ekadashi Shraddha</td>
                                      <td>Ashwina, Krishna Ekadashi</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 29, 2024, Sunday</strong></td>
                                      <td>Magha Shraddha</td>
                                      <td>Ashwina, Magha Nakshatra</td>
                                    </tr>
                                    <tr>
                                      <td><strong>September 29, 2024, Sunday</strong></td>
                                      <td>Dwadashi Shraddha</td>
                                      <td>Ashwina, Krishna Dwadashi</td>
                                    </tr>
                                    <tr>
                                      <td><strong>October 12, 2024, Thursday</strong></td>
                                      <td>Magha Shraddha</td>
                                      <td>Ashwina, Magha Nakshatra</td>
                                    </tr>
                                    <tr>
                                      <td><strong>October 1, 2024, Tuesday</strong></td>
                                      <td>Chaturdashi Shraddha</td>
                                      <td>Ashwina, Krishna Chaturdashi</td>
                                    </tr>
                                    <tr>
                                      <td><strong>October 2, 2024, Wednesday</strong></td>
                                      <td>Sarva Pitru Amavasya</td>
                                ...
                                <div class="swiper videosSlider">
                                  <div class="swiper-wrapper">
                                    <div class="swiper-slide videowrapper d-none d-lg-block">
                                      ...
                                      <div class="introvideo videoButton " data-video-id="9Q5_01xwM6c" role="button">
                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                          data-src="https://img.youtube.com/vi/9Q5_01xwM6c/hqdefault.jpg" width="614" height="345"
                                      ...
                                      <div class="swiper-slide videowrapper d-none d-lg-block">
                                        ...
                                        <div class="introvideo videoButton " data-video-id="fzMaY95CeYU" role="button">
                                          <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                            data-src="https://img.youtube.com/vi/fzMaY95CeYU/hqdefault.jpg" width="614" height="345"
                                            class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                              data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                              class="play-icon lazyload" alt="Play Icon"/>
                                        ...
                                        <div class="swiper-slide videowrapper d-none d-lg-block">
                                          ...
                                          <div class="introvideo videoButton " data-video-id="JX1sFHvI9N0" role="button">
                                            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                              data-src="https://img.youtube.com/vi/JX1sFHvI9N0/hqdefault.jpg" width="614" height="345"
                                              class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                              <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                                class="play-icon lazyload" alt="Play Icon"/>
                                          ...
                                          <div class="swiper-slide videowrapper d-none d-lg-block">
                                            ...
                                            <div class="introvideo videoButton " data-video-id="hBp4N1RbRbA" role="button">
                                              <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                data-src="https://img.youtube.com/vi/hBp4N1RbRbA/hqdefault.jpg" width="614" height="345"
                                                class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                  data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                                  class="play-icon lazyload" alt="Play Icon"/>
                                            ...
                                            <div class="swiper-slide videowrapper d-lg-none">
                                              <div class="introvideo videoButton " data-video-id="Dl0WwKiY_HI" role="button">
                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                  data-src="https://img.youtube.com/vi/Dl0WwKiY_HI/hqdefault.jpg" width="1920" height="1080"
                                                  class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                    data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                                    class="play-icon lazyload" alt="Play Icon"/>
                                              ...
                                              <div class="swiper-slide videowrapper d-lg-none">
                                                <div class="introvideo videoButton " data-video-id="lwvFRRfkGG0" role="button">
                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                    data-src="https://img.youtube.com/vi/lwvFRRfkGG0/hqdefault.jpg" width="1920" height="1080"
                                                    class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                      data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                                      class="play-icon lazyload" alt="Play Icon"/>
                                                ...
                                                <div class="swiper-slide videowrapper d-lg-none">
                                                  <div class="introvideo videoButton " data-video-id="ttmzXeOu33Y" role="button">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                      data-src="https://img.youtube.com/vi/ttmzXeOu33Y/hqdefault.jpg" width="1920" height="1080"
                                                      class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                        data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                                        class="play-icon lazyload" alt="Play Icon"/>
                                                  ...
                                                  <div class="swiper-slide videowrapper d-lg-none">
                                                    <div class="introvideo videoButton " data-video-id="E9brZk2XmEI" role="button">
                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                        data-src="https://img.youtube.com/vi/E9brZk2XmEI/hqdefault.jpg" width="1920" height="1080"
                                                        class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                          data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                                          class="play-icon lazyload" alt="Play Icon"/>
                                                    ...
                                                    <div class="swiper-slide videowrapper d-lg-none">
                                                      <div class="introvideo videoButton " data-video-id="5aKbWi7ZQLI" role="button">
                                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                          data-src="https://img.youtube.com/vi/5aKbWi7ZQLI/hqdefault.jpg" width="1920" height="1080"
                                                          class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                                          <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                            data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                                            class="play-icon lazyload" alt="Play Icon"/>
                                              ...
                                              <section class="share-tags template__section pt-3" id="whatwedo">
                                                <h3 class="heading border-bottom-2">Pitru Paksha Puja / Shradh Puja 2024 at Shree Krishnayan
                                                  Gauraksha </h3>


                                                <a href="new-assets/images/shradh/7.html" data-fancybox=""
                                                  class="position-relative d-block leftimage"> <img src="new-assets/images/shradh/7.html"
                                                    class="fixratio" width="350" height="300" alt=""/>
                                                    <span class="innerlargeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                                </a>

                                                <p class="text-justify ">Shradh is a
                                                  ritual to pay homage to one's deceased family members- ancestors. You can choose from
                                                  different kind of rituals which can be performed on your chosen date. <a
                                                    href="index.html"> Shree Krishnayan Gauraksha</a>
                                                  understands the significance of Pitru Paksha, a solemn duty that families owe to their departed
                                                  relatives. We diligently follow the guidance of the Vedas and Granthas, conducting Shradha puja
                                                  with deep respect to scriptural traditions.</p>
                                                <p class="text-justify ">Our experienced priests conduct these ceremonies with professionalism,
                                                  amidst the divine
                                                  environment of the holy Ganga river in Haridwar. We ensure that our puja services are of the
                                                  highest quality and aligned with Hindu customs. During this period, we perform Vedic rituals to
                                                  seek blessings from Gaumata, revered as divine in Hindu scriptures. At our institution, <a
                                                    href="index.html"> Shree
                                                    Krishnayan Desi Gauraksha</a>, Vedic Brahmins perform various rituals and prayers for the
                                                  welfare of
                                                  all. At our gaushala, we are blessed with a magnificent yagyamandap. Accomplished Vedic Brahmins
                                                  conduct various sacred rituals, including Yagyas, Pujas and Japas, with utmost precision and
                                                  devotion. These spiritual endeavors are undertaken for the well-being and welfare of the people,
                                                  creating an atmosphere of divine grace and positive energy for Pitru Paksha.</p>

                                                <p class="text-justify ">We offer a hassle-free ceremony with a range of services including Tirth
                                                  Purohit, Arrangements
                                                  for Pind Daan, Accommodation with Experienced Pandits, and Puja conducted according to Shastras.
                                                  Additionally, we provide online video-conferencing facilities and Poojan Samagri Kits in a
                                                  sacred setting where over 22,000 desi cows are lovingly sheltered.</p>
                                                <p class="text-justify ">
                                                  We extend our warm invitation to you to visit <a href="index.html">
                                                    Shree Krishnayan Gauraksha</a>, where you can seek the
                                                  blessings of the Holy cow and fulfill your duty towards your departed loved ones. By performing
                                                  Shradh during Pitru Paksha, you not only pay homage to your ancestors but also invoke blessings
                                                  of well-being, tranquility, and prosperity upon your family. Booking your puja service is made
                                              ...
                                              <section class="share-tags template__section pt-3" id="whatwedo">
                                                <h3 class="heading border-bottom-2"><p>What We Should Do For The Departed Souls</p></h3>
                                                <p class=" font-16 text-justify "><p>Gaumata 33 crore devatas reside in our gaumata . Whatever we feed to our gaumata reaches our pitra. Its makes them happy and satisfied. Gaumata, takes us out of all obstacles will give salvation to our pitra, If served properly.</p><p><strong>You can do the following</strong></p><p><strong>Tirth Shradh &amp; tarpan-&nbsp;</strong> tarpan-&nbsp;You can perform shradh and tarpan for your deceased family members on the bank of Maa Ganga. This will alleviate the deceased soul to higher lokas</p><p><strong>Yagya &amp; Pooja for Pitra-&nbsp;&nbsp;</strong> If the death of you family member was more than a year back than you can do a detailed Yagya and pooja for him. This Yagya and pooja will definitely give him happiness and peace.</p><p><strong>Godaan- </strong>-&nbsp;It is the most powerful and pure donation anyone can do in their lifetime. Performing gaudaan helps a person getting rid of all his sins, also removes all the obstacles. It also elevates the deceased soul to heaven and also removes the pitra dosh of the donor.</p><p><strong>Bhandara for 11 Saints / Brahmins – </strong>You can do bhandara for 11 saints or Vedic Brahmins for the peace and happiness of the departed soul.</p><p><strong>Feed Gaugrass-&nbsp;</strong> Gaugrass in the form of green grass, wheat bran and jaggery to our desi mother cows.</p> </p>
                                              </section>
                                              <div class="col-lg-12">
                                                <h3 class="fw-semibold fs-5   fs-m-16 addbullet">Gallery:-</h3>
                                              </div>


                                              <div class="col-lg-12 sarrows">
                                                ...
                                                <div class="position-relative">
                                                  <div class="swiper galleryslider">
                                                    <div class="swiper-wrapper">
                                                      <div class="swiper-slide">
                                                        <a href="https://docs.krishnayangauraksha.org/dynamic_page/2125706158gau.webp" data-fancybox="gallery">
                                                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/2125706158gau.webp" alt=""/>
                                                            <span class="largeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                                        </a>


                                                      </div>
                                                      <div class="swiper-slide">
                                                        <a href="https://docs.krishnayangauraksha.org/dynamic_page/677165436gaupujan.webp" data-fancybox="gallery">
                                                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/677165436gaupujan.webp" alt=""/>
                                                            <span class="largeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                                        </a>
                                                      ...
                                                      <div class="swiper-slide">
                                                        <a href="https://docs.krishnayangauraksha.org/dynamic_page/685819095jap.webp" data-fancybox="gallery">
                                                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/685819095jap.webp" alt=""/>
                                                            <span class="largeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                                        </a>
                                                      ...
                                                      <div class="swiper-slide">
                                                        <a href="https://docs.krishnayangauraksha.org/dynamic_page/2107869639rishi.webp" data-fancybox="gallery">
                                                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/2107869639rishi.webp" alt=""/>
                                                            <span class="largeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                                        </a>
                                                      ...
                                                      <div class="swiper-slide">
                                                        <a href="https://docs.krishnayangauraksha.org/dynamic_page/1419013589fakkar.webp" data-fancybox="gallery">
                                                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/1419013589fakkar.webp" alt=""/>
                                                            <span class="largeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                                        </a>
                                                      ...
                                                      <div class="swiper-slide">
                                                        <a href="https://docs.krishnayangauraksha.org/dynamic_page/785680847yagya.webp" data-fancybox="gallery">
                                                          <img src="https://docs.krishnayangauraksha.org/dynamic_page/785680847yagya.webp" alt=""/>
                                                            <span class="largeicon"><i class="fa fa-expand" aria-hidden="true"></i></span>
                                                        </a>
                                              ...
                                              <section class="template__section pt-3" id="about">
                                                <div class="gallery">
                                                  <h3 class="heading border-bottom-2 pb-3">About us:-</h3>
                                                  <p class="font-16 mt-3"> ‘Shree Krishnayan Desi Gauraksha Evam Gaulok Dham Sewa Samiti’ is one
                                                    of the largest Gaurakshashala of desi cows in India. We protect, feed &amp; shelter ailing,
                                                    starving, destitute and stray desi cows majority of which are abandoned by their owners or
                                                    saved from butchers. Most of these Gauvansh are milk barren. This gaushala is run and
                                                    managed by saints. We do not sell milk or milk products. We started with just 11 cows in the
                                                    year 2010 in Haridwar and presently we shelter and feed more than 21000 cows We are
                                                    registered with Animal Welfare Board of India (Chennai) and with animal welfare board in
                                                    various states. </p>
                                                </div>
                                                <div class="gy-3 row ">
                                              ...
                                              <section class="donars_list pt-3 template__section" id="Donors">
                                                <h4 class="heading border-bottom-2 pb-3">Donors:-</h4>
                                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                  <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Most Generous</button>
                                                  </li>
                                                  <li class="nav-item" role="presentation">
                                                        ...
                                                        <div class="card">
                                                          <div class="d-flex align-items-center p-2">
                                                            <div class="me-2"> <img
                                                              ...
                                                              class="img-fluid rounded-start lazyload" alt="donor"/> </div>
                                                            <div class="lh-base">
                                                      ...
                                                      <div class="col-md-4">
                                                        <div class="card">
                                                          <div class="d-flex align-items-center p-2">
                                                            ...
                                                            <div class="lh-base">
                                                              <h5 class="card-title mb-0 fs-6 ">
                                                                Chandrika Praveen                                                </h5>
                                                              <p class="m-0 fs-16 fw-normal">Donated <strong> ₹
                                                                800                                                    </strong> </p>
                                                              <p class="m-0"><small class="text-muted">
                                                                30-01-2025 10:03:41                                                    </small></p>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      </div>
                                                      ...
                                                      <div class="col-md-4">
                                                        <div class="card">
                                                          <div class="d-flex align-items-center p-2">
                                                            ...
                                                            <div class="lh-base">
                                                              <h5 class="card-title mb-0 fs-6 ">
                                                                Kadambari Suryavanshi                                                </h5>
                                                              <p class="m-0 fs-16 fw-normal">Donated <strong> ₹
                                                                500                                                    </strong> </p>
                                                              <p class="m-0"><small class="text-muted">
                                                                30-01-2025 10:14:07                                                    </small></p>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      </div>
