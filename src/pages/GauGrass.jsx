        ...
        <div class="container">
          <div class="row gy-4">
            <div class="col-lg-12">
              ...
              <h2
                class="text-center fw-semibold text-primary fs-4 fs-m-14 d-md-flex justify-content-center gap-2 mt-3">
              ...
              <h6 class="text-center mb-0 fw-semibold d-md-flex fs-m-14 justify-content-center gap-2">Where cows are
                happy,
                ...
                <section class="col-lg-12 px-0 px-lg-3">
                  <div class="swiper mainbanner">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <img src="../docs.krishnayangauraksha.org/dynamic_page/999998924gaugrass.jpg" class="d-none d-lg-block rounded-0 w-100 img-fluid"
                  ...
                  <div class="mobile-banner d-lg-none">
                    <div class="swiper mobile-slider2">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img src="../docs.krishnayangauraksha.org/dynamic_page/14160898691727526194gau1.jpg" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="../docs.krishnayangauraksha.org/dynamic_page/1043269471727526194gau3.jpg" alt=""/>
                        </div>
                        <div class="swiper-slide">
                          <img src="../docs.krishnayangauraksha.org/dynamic_page/7028063441727526194gau4.jpg" alt=""/>
                        </div>
                      </div>
                      <div class="swiper-pagination"></div>
                    </div>
                    <h3>Give These Stray Cows & Bulls, A happy Life</h3>
                 ...
                 <div class="second-nav">
                  ...
                  <div class="row g-2 mb-4" id="donatetable">
                    ...
                    <div class="col-xl-4 col-lg-6  col-6">
                      <div class="card  newcard mncard">
                        <div class="card-body">
                          <h3 class="italic">Medicines</h3>

                          <img src="administrator/assets/uploads/campaign_page/648a9cbb476ba37b3b2009c4c5fd7fb4.jpg"
                            width="382" height="160" class="img-fluid" alt="Medicines"/>

                            <div class="showtwolines paragraph-text"> As we shelter old & destitute gauvansh majorly saved from critical conditions. We regularly require medical help for these saved gauvansh so that they can live a happy life. </div>
                            <div class="text-warning fs-14  read-more" role="button">Read more</div>


                            <button class="btn  btn-warning   mt-lg-3 d-flex align-items-center  justify-content-center"
                              id="category_ID4"
                              onclick="productmodel(4,3)">
                              <i class="fa-solid fa-cart-shopping"></i> Add
                              Items <span class="ms-1"> to Donate</span></button>
                  ...
                  <div class="modal" id="newpaymentmodal" tabindex="-1">
                    <div class="modal-dialog modal-fullscreen-md-down">
                      ...
                      <section class="col-lg-12">
                        <h3 class="addbullet"><p>Cause:-</p></h3>
                        <div class="text-justify addreadmore"><p><span style={{color:"rgb(0,0,0)"}}><strong>Fodder for Cows: Why It Matters</strong> When cows get old and stop giving milk, their owners often abandon them because they think they are useless. Thousands of these innocent Gaumata are left without a home and food. Many are old, injured or simply abandoned. Shree Krishnayan Desi Gaurakshashala is committed to changing this narrative. Our gaushala serves as a Gaushala for over 20,000 desi cows, providing them with shelter, nourishment, and medical care. Thousands of Gauvansh have found shelter in Shree Krishnayan Desi Gaurakshashala. Earlier, all these Gauvansh used to roam helplessly on the streets and fields. There was no proper arrangement for feeding them. When they were chased away from the fields, they would come to the streets. If someone threw something for them, they would eat it. Otherwise, they would often search for fodder in garbage heaps. But after reaching Shree Krishnayan Desi Gaurakshashala, these Cows get to eat chaff, bran, green fodder and sometimes jaggery. Also, every week the veterinary doctor visits the gaushala and checks the health of these animals.&nbsp;</span></p><p><span style={{color:"rgb(0,0,0)"}}>However, providing fodder for such a large number of cows is a costly task. We need your support to continue our mission. By collaborating with Shree Krishnayan Gauraksha, you can help us supply essential fodder, medication, and care for these helpless cows and bulls. Your contribution can make a meaningful difference in their lives, offering them the dignity and care they deserve.&nbsp;</span></p><p><span style={{color:"rgb(0,0,0)"}}>Join us in our mission to provide food for them and honor their invaluable contributions to our lives.</span></p></div>
                        <button class="rmbtn">Read More</button>
                      </section>
                      <section class="col-lg-12 d-lg-none">
                        <a href="#online-gaushala-visit" data-bs-toggle="modal"><img
                          src="new-assets/images/live.html" class="rounded-4"
                          alt=""/></a>
                      </section>
                      <section class="col-lg-12">
                          ...
                          <div class="mobile-overflow swiper accswiper">
                            <ul class="accrediations swiper-wrapper">
                              <li class="swiper-slide"><img
                                ...
                                data-src="new-assets/images/authorised/80g.html"
                              ...
                              <li class="swiper-slide"><img
                                src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                data-src="new-assets/images/authorised/animal.html"
                              ...
                              <li class="swiper-slide"><img
                                src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                data-src="new-assets/images/authorised/niti.html"
                      ...
                      <section class="col-lg-12">
                        <ul class="achives rainbow ">
                          <li class="ribbon">
                            <h3>WE SHELTER & FEED 21000+ INJURED, ABANDONED, STRAY COWS & BULLS.</h3>
                          </li>
                          <li class="ribbon">
                            <h3>complete INHOUSE FACILITY TO CARE FOR COWS</h3>
                          </li>
                          <li class="ribbon">
                            <h3>WE DON'T SELL MILK OR MILK PRODUCTS</h3>
                          </li>
                          <li class="ribbon">
                            <h3>Government Certified and Approved</h3>
                          </li>
                      ...
                      <section class="col-lg-12">
                        <div class="swiper iso-slider my-3">
                          <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class="authanim"><img data-src="../docs.krishnayangauraksha.org/donation_page/images/iso.png"
                                alt="iSO Certificate logo" class="lazyload"/></div>
                            </div>
                            <div class="swiper-slide">
                              <div class="authanim"><img data-src="../docs.krishnayangauraksha.org/donation_page/images/2011.png"
                                alt="Government Certified Logo" class="lazyload"/></div>
                            </div>
                            <div class="swiper-slide">
                              <div class="authanim"><img
                                data-src="../docs.krishnayangauraksha.org/donation_page/images/IAF-logo-removebg-preview1.png"
                          ...
                          <div class="swiper videosSlider">
                            <div class="swiper-wrapper">
                              <div class="swiper-slide videowrapper d-none d-lg-block">
                                ...
                                <div class="introvideo videoButton " data-video-id="COQGrkZuKN4" role="button">
                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                    data-src="https://img.youtube.com/vi/COQGrkZuKN4/hqdefault.jpg" width="614" height="345"
                                ...
                                <div class="swiper-slide videowrapper d-lg-none">
                                  <div class="introvideo videoButton " data-video-id="oRYwS7xhEfk" role="button">
                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                      data-src="https://img.youtube.com/vi/oRYwS7xhEfk/hqdefault.jpg" width="1920" height="1080"
                                      class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                        data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                        class="play-icon lazyload" alt="Play Icon"/>
                                  ...
                                  <div class="swiper-slide videowrapper d-lg-none">
                                    <div class="introvideo videoButton " data-video-id="wtV5USa0_Ms" role="button">
                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                        data-src="https://img.youtube.com/vi/wtV5USa0_Ms/hqdefault.jpg" width="1920" height="1080"
                                        class="w-100 videothumb lazyload" alt="About Krishnayan Video Thumbnail"/>
                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                          data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70" height="70"
                                          class="play-icon lazyload" alt="Play Icon"/>
                                        ...
                                        <div class="row g-4">
                                          <div class="col-lg-5">
                                            <div class="videowrapper h-100">
                                              <div class="introvideo videoButton h-100" data-video-id="dkAQhlkZ2is"
                                                role="button">
                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                  data-src="../img.youtube.com/vi/dkAQhlkZ2is/hqdefault.jpg"
                                                  width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                  alt="About Krishnayan Video Thumbnail"/>
                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                    data-src="new-assets/images/play-icon.svg"
                                                    width="70" height="70" class="play-icon lazyload" alt="Play Icon"/>
                                                  </div>
                                              </div>
                                            </div>
                                            <div class="col-lg-7">
                                              <h3 class="fs-4 mb-3 ">Feeding Cows</h3>
                                              <p><i class="fa-solid fa-calendar-days"></i> 2024-12-01 17:03:51</p>
                                              <p class="mb-0"><p>Full working process of fodder distribution</p></p>
                                      ...
                                      <div class="swiper-slide">
                                        <div class="alertmsg">
                                          <div class="row g-4">
                                            <div class="col-lg-5">
                                              <div class="videowrapper h-100">
                                                <div class="introvideo videoButton h-100" data-video-id="9AJH3_Xq0UM"
                                                  role="button">
                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                    data-src="../img.youtube.com/vi/9AJH3_Xq0UM/hqdefault.jpg"
                                                    width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                    alt="About Krishnayan Video Thumbnail"/>
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                      data-src="new-assets/images/play-icon.svg"
                                              ...
                                              <div class="col-lg-7">
                                                <h3 class="fs-4 mb-3 ">Gaugrass from Manoj Mishra</h3>
                                                <p><i class="fa-solid fa-calendar-days"></i> 2024-12-05 16:23:34</p>
                                                <p class="mb-0"><p>Fodder distribution on behalf of donor</p></p>
                                                <div class="d-flex align-items-center gap-1 mt-4">
                                                   <button
                                                    class="btn btn-primary">Help & Save Life</button> 
                                                  <div class="next-issue btn btn-primary">Previous Update</div>
                                        ...
                                        <div class="swiper-slide">
                                          <div class="alertmsg">
                                            <div class="row g-4">
                                              <div class="col-lg-5">
                                                <div class="videowrapper h-100">
                                                  <div class="introvideo videoButton h-100" data-video-id="Ew5CVmk8VWI"
                                                    role="button">
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                      data-src="../img.youtube.com/vi/Ew5CVmk8VWI/hqdefault.jpg"
                                                      width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                      alt="About Krishnayan Video Thumbnail"/>
                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                        data-src="new-assets/images/play-icon.svg"
                                                ...
                                                <div class="col-lg-7">
                                                  <h3 class="fs-4 mb-3 ">Green Fodder</h3>
                                                  <p><i class="fa-solid fa-calendar-days"></i> 2024-12-31 19:59:27</p>
                                                  <p class="mb-0"><p>Cabbage for gauvansh</p></p>
                                                  <div class="d-flex align-items-center gap-1 mt-4">
                                                     <button
                                                      class="btn btn-primary">Help & Save Life</button> 
                                                    <div class="next-issue btn btn-primary">Previous Update</div>
                                          ...
                                          <div class="swiper-slide">
                                            <div class="alertmsg">
                                              <div class="row g-4">
                                                <div class="col-lg-5">
                                                  <div class="videowrapper h-100">
                                                    <div class="introvideo videoButton h-100" data-video-id="cbCsxPBEdb4"
                                                      role="button">
                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                        data-src="../img.youtube.com/vi/cbCsxPBEdb4/hqdefault.jpg"
                                                        width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                        alt="About Krishnayan Video Thumbnail"/>
                                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                          data-src="new-assets/images/play-icon.svg"
                                                  ...
                                                  <div class="col-lg-7">
                                                    <h3 class="fs-4 mb-3 ">Unloading of bhusa</h3>
                                                    <p><i class="fa-solid fa-calendar-days"></i> 2025-01-02 18:56:13</p>
                                                    <p class="mb-0"><p>A Truckload of Fodder Arrived for Gaumata</p></p>
                                                    <div class="d-flex align-items-center gap-1 mt-4">
                                                       <button
                                                        class="btn btn-primary">Help & Save Life</button>
                                                      <div class="next-issue btn btn-primary">Previous Update</div>
                                            ...
                                            <div class="swiper-slide">
                                              <div class="alertmsg">
                                                <div class="row g-4">
                                                  <div class="col-lg-5">
                                                    <div class="videowrapper h-100">
                                                      <div class="introvideo videoButton h-100" data-video-id="fNez4MUiYvM"
                                                        role="button">
                                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                          data-src="../img.youtube.com/vi/fNez4MUiYvM/hqdefault.jpg"
                                                          width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                          alt="About Krishnayan Video Thumbnail"/>
                                                          <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                            data-src="new-assets/images/play-icon.svg"
                                                    ...
                                                    <div class="col-lg-7">
                                                      <h3 class="fs-4 mb-3 ">Unloading of mustard cake</h3>
                                                      <p><i class="fa-solid fa-calendar-days"></i> 2025-01-03 20:06:25</p>
                                                      <p class="mb-0">Unloading of truck of mustrad cake in Shree Krishnayan</p>
                                                      <div class="d-flex align-items-center gap-1 mt-4">
                                                        <button
                                                          class="btn btn-primary">Help & Save Life</button>
                                                        <div class="next-issue btn btn-primary">Previous Update</div>
                                              ...
                                              <div class="swiper-slide">
                                                <div class="alertmsg">
                                                  <div class="row g-4">
                                                    <div class="col-lg-5">
                                                      <div class="videowrapper h-100">
                                                        <div class="introvideo videoButton h-100" data-video-id="hOQmAv4w5QE"
                                                          role="button">
                                                          <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                            data-src="../img.youtube.com/vi/hOQmAv4w5QE/hqdefault.jpg"
                                                            width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                            alt="About Krishnayan Video Thumbnail"/>
                                                            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                              data-src="new-assets/images/play-icon.svg"
                                                      ...
                                                      <div class="col-lg-7">
                                                        <h3 class="fs-4 mb-3 ">Green fodder</h3>
                                                        <p><i class="fa-solid fa-calendar-days"></i> 2025-01-10 23:04:32</p>
                                                        <p class="mb-0"><p>Unloading and cutting of green grass</p></p>
                                                        <div class="d-flex align-items-center gap-1 mt-4">
                                                          <button
                                                            class="btn btn-primary">Help & Save Life</button>
                                                          <div class="next-issue btn btn-primary">Previous Update</div>
                                                ...
                                                <div class="swiper-slide">
                                                  <div class="alertmsg">
                                                    <div class="row g-4">
                                                      <div class="col-lg-5">
                                                        <div class="videowrapper h-100">
                                                          <div class="introvideo videoButton h-100" data-video-id="qMa_t5bBG4I"
                                                            role="button">
                                                            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                              data-src="../img.youtube.com/vi/qMa_t5bBG4I/hqdefault.jpg"
                                                              width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                              alt="About Krishnayan Video Thumbnail"/>
                                                              <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                data-src="new-assets/images/play-icon.svg"
                                                        ...
                                                        <div class="col-lg-7">
                                                          <h3 class="fs-4 mb-3 ">Truck of bhusa</h3>
                                                          <p><i class="fa-solid fa-calendar-days"></i> 2025-01-16 21:40:00</p>
                                                          <p class="mb-0"><p>A truckload of fodder arrived today for the cows at Shree Krishnayan.</p></p>
                                                          <div class="d-flex align-items-center gap-1 mt-4">
                                                             <button
                                                              class="btn btn-primary">Help & Save Life</button>
                                                            <div class="next-issue btn btn-primary">Previous Update</div>
                                                  ...
                                                  <div class="swiper-slide">
                                                    <div class="alertmsg">
                                                      <div class="row g-4">
                                                        <div class="col-lg-5">
                                                          <div class="videowrapper h-100">
                                                            <div class="introvideo videoButton h-100" data-video-id="wjsDfoBv7Mw"
                                                              role="button">
                                                              <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                data-src="../img.youtube.com/vi/wjsDfoBv7Mw/hqdefault.jpg"
                                                                width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                                alt="About Krishnayan Video Thumbnail"/>
                                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                  data-src="new-assets/images/play-icon.svg"
                                                          ...
                                                          <div class="col-lg-7">
                                                            <h3 class="fs-4 mb-3 ">Green fodder for Gaumata</h3>
                                                            <p><i class="fa-solid fa-calendar-days"></i> 2025-01-23 20:06:18</p>
                                                            <p class="mb-0"><p>A trolly of green grass Arrived for Gaumata at Shree Krishnayan</p></p>
                                                            <div class="d-flex align-items-center gap-1 mt-4">
                                                              <button
                                                                class="btn btn-primary">Help & Save Life</button>
                                                              <div class="next-issue btn btn-primary">Previous Update</div>
                                                    ...
                                                    <div class="swiper-slide">
                                                      <div class="alertmsg">
                                                        <div class="row g-4">
                                                          <div class="col-lg-5">
                                                            <div class="videowrapper h-100">
                                                              <div class="introvideo videoButton h-100" data-video-id="94PWMJpoxFg"
                                                                role="button">
                                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                  data-src="../img.youtube.com/vi/94PWMJpoxFg/hqdefault.jpg"
                                                                  width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                                  alt="About Krishnayan Video Thumbnail"/>
                                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                    data-src="new-assets/images/play-icon.svg"
                                                            ...
                                                            <div class="col-lg-7">
                                                              <h3 class="fs-4 mb-3 ">Green grass for gaumata</h3>
                                                              <p><i class="fa-solid fa-calendar-days"></i> 2025-01-28 12:37:02</p>
                                                              <p class="mb-0"><p>A trolly of green grass is unloading for gaumata</p></p>
                                                              <div class="d-flex align-items-center gap-1 mt-4">
                                                                <button
                                                                  class="btn btn-primary">Help & Save Life</button> 
                                                                <div class="next-issue btn btn-primary">Previous Update</div>
                                                      ...
                                                      <div class="swiper-slide">
                                                        <div class="alertmsg">
                                                          <div class="row g-4">
                                                            <div class="col-lg-5">
                                                              <div class="videowrapper h-100">
                                                                <div class="introvideo videoButton h-100" data-video-id="p8NaAd-O3B8"
                                                                  role="button">
                                                                  <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                    data-src="../img.youtube.com/vi/p8NaAd-O3B8/hqdefault.jpg"
                                                                    width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                                    alt="About Krishnayan Video Thumbnail"/>
                                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                      data-src="new-assets/images/play-icon.svg"
                                                              ...
                                                              <div class="col-lg-7">
                                                                <h3 class="fs-4 mb-3 ">Bajra for gaumata</h3>
                                                                <p><i class="fa-solid fa-calendar-days"></i> 2025-01-29 12:42:26</p>
                                                                <p class="mb-0"><p>A trolly of bajra for gaugrass came for gaumata</p></p>
                                                                <div class="d-flex align-items-center gap-1 mt-4">
                                                                   <button
                                                                    class="btn btn-primary">Help & Save Life</button>
                                                                  <div class="next-issue btn btn-primary">Previous Update</div>
                                                        ...
                                                        <div class="swiper-slide">
                                                          <div class="alertmsg">
                                                            <div class="row g-4">
                                                              <div class="col-lg-5">
                                                                <div class="videowrapper h-100">
                                                                  <div class="introvideo videoButton h-100" data-video-id="pzYETo57wQ4"
                                                                    role="button">
                                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                      data-src="../img.youtube.com/vi/pzYETo57wQ4/hqdefault.jpg"
                                                                      width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                                      alt="About Krishnayan Video Thumbnail"/>
                                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                        data-src="new-assets/images/play-icon.svg"
                                                                ...
                                                                <div class="col-lg-7">
                                                                  <h3 class="fs-4 mb-3 ">A trolly of green grass</h3>
                                                                  <p><i class="fa-solid fa-calendar-days"></i> 2025-02-11 20:08:42</p>
                                                                  <p class="mb-0"><p>A trolly of green grass distributed to gauvansh</p></p>
                                                                  <div class="d-flex align-items-center gap-1 mt-4">
                                                                    <button
                                                                      class="btn btn-primary">Help & Save Life</button>
                                                                    <div class="next-issue btn btn-primary">Previous Update</div>
                                                          ...
                                                          <div class="swiper-slide">
                                                            <div class="alertmsg">
                                                              <div class="row g-4">
                                                                <div class="col-lg-5">
                                                                  <div class="videowrapper h-100">
                                                                    <div class="introvideo videoButton h-100" data-video-id="4TWgWndxoas"
                                                                      role="button">
                                                                      <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                        data-src="../img.youtube.com/vi/4TWgWndxoas/hqdefault.jpg"
                                                                        width="1920" height="1080" class="w-100 videothumb lazyload h-100 object-fit-cover"
                                                                        alt="About Krishnayan Video Thumbnail"/>
                                                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                          data-src="new-assets/images/play-icon.svg"
                                                                  ...
                                                                  <div class="col-lg-7">
                                                                    <h3 class="fs-4 mb-3 ">Trolly of green grass</h3>
                                                                    <p><i class="fa-solid fa-calendar-days"></i> 2025-02-27 20:07:09</p>
                                                                    <p class="mb-0"><p><span>A truckload of fodder
                                                                      arrived at the Gaushala.</span></p></p>
                                                                    <div class="d-flex align-items-center gap-1 mt-4">
                                                                       <button
                                                                        class="btn btn-primary">Help & Save Life</button>
                                                                      <div class="next-issue btn btn-primary">Previous Update</div>
                                                      ...
                                                      <div class="sarrows">
                                                        <div class="position-relative">
                                                          <div class="swiper galleryslider">
                                                            <div class="swiper-wrapper">
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/2020505864gau1.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/2020505864gau1.jpg" alt=""/>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/1068368930gau2.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/1068368930gau2.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/882856203gau3.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/882856203gau3.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/1249910545gau4.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/1249910545gau4.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/230482355gau5.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/230482355gau5.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/1010721676gau6.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/1010721676gau6.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/474406850gau7.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/474406850gau7.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/2038210908gau8.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/2038210908gau8.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                              ...
                                                              <div class="swiper-slide">
                                                                <a href="../docs.krishnayangauraksha.org/dynamic_page/1963498807gau9.jpg" data-fancybox="gallery">
                                                                  <img src="../docs.krishnayangauraksha.org/dynamic_page/1963498807gau9.jpg" alt=""/>
                                                                    <span class="largeicon"><i class="fa fa-expand"
                                                                      aria-hidden="true"></i></span>
                                                                </a>
                                                    ...
                                                    <section class="col-lg-12">
                                                      <div class="gallery ">
                                                        ...
                                                        <div class="introvideo videoButton d-none d-lg-block" data-video-id="ijoyg3L5kFk"
                                                          role="button">
                                                          <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                            data-src="https://img.youtube.com/vi/ijoyg3L5kFk/maxresdefault.jpg" width="614"
                                                            height="345" class="videothumb lazyload img-fluid"
                                                            alt="About Krishnayan Video Thumbnail"/>
                                                            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                              data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70"
                                                              height="70" class="play-icon lazyload" alt="Play Icon"/>
                                                            </div>

                                                            <div class="introvideo videoButton d-lg-none" data-video-id="khPlrI-jJRI" role="button">
                                                              <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                data-src="https://img.youtube.com/vi/khPlrI-jJRI/maxresdefault.jpg" width="1920"
                                                                height="1080" class="w-100 videothumb lazyload"
                                                                alt="About Krishnayan Video Thumbnail"/>
                                                                <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                                  data-src="https://www.krishnayangauraksha.org/new-assets/images/play-icon.svg" width="70"
                                                                  height="70" class="play-icon lazyload" alt="Play Icon"/>
                                                                ...
                                                                <p class="font-16 mt-3 "> ‘Shree Krishnayan Desi Gauraksha Evam Gaulok Dham Sewa Samiti’
                                                                  is one
                                                                  of the largest Gaurakshashala of desi cows in India. We protect, feed &amp; shelter
                                                                  ailing,
                                                                  starving, destitute and stray desi cows majority of which are abandoned
                                                                  by their owners or saved from butchers. Most of these Gauvansh are milk barren. This
                                                                  gaushala is run and managed by saints. We do not sell milk or milk products. We
                                                                  started with
                                                                  just 11 cows in the year 2010 in Haridwar and presently
                                                                  we shelter and feed more than 21000 cows We are registered with Animal Welfare Board
                                                                  of
                                                                  India (Chennai) and with animal welfare board in various states. </p>
                                                                  ...
                                                                  <div class="col-md-4">
                                                                    <div class="card mb-3">
                                                                      <div class="d-flex align-items-center p-2">
                                                                        <div class="me-2"> <img
                                                                          data-src="../docs.krishnayangauraksha.org/donation_page/images/user.png"
                                                              ...
                                                              <div class="col-12">
                                                                <div class="card rounded-4 border-0 shadow-sm">
                                                                  <div class="card-body">
                                                                    ...
                                                                    <div class="required_donation bg-white p-3">
                                                                      <div class="row">
                                                                        <div class="col-12">
                                                                          <div class="d-flex flex-wrap ls-none align-items-center">

                                                                            <div class="col-3 lh-sm ">
                                                                              <div class="d-flex flex-wrap">
                                                                               
                                                                                <svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="70"
                                                                                  ...
                                                                                  <circle class="circle-chart__circle" stroke="#00acc1" stroke-width="2"
                                                                                    stroke-dasharray="11,100" stroke-linecap="round"
                                                                                    fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
                                                                                  <g class="circle-chart__info">
                                                                                    <text class="circle-chart__percent" x="16.91549431" y="12.5"
                                                                                      alignment-baseline="central" font-weight="bold" text-anchor="middle"
                                                                                      font-size="9">
                                                                                      11                                                %</text>
                                                                                    <text class="circle-chart__percent" x="16.91549431" y="21.5"
                                                                                      alignment-baseline="central" text-anchor="middle"
                                                                                      font-size="5">Complete</text>
                                                                                  </g>
                                                                                </svg>
                                                                              </div>
                                                                            </div>
                                                                            <div class="col-9 lh-sm ps-2">
                                                                              <div class="row ">
                                                                                <div class="col-6"> <span class="fw-bold">Mar 2025</span>
                                                                                  <div class="small"> Month </div>
                                                                                </div>
                                                                                <div class="col-6"> <span class="fw-bold">31 Lakh Kg</span>
                                                                                  <div class="small"> Total Fodder Required </div>
                                                                                </div>
                                                                              </div>
                                                                            </div>
                                                                          </div>
